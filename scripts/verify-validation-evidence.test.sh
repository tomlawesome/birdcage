...
print(json.dumps({
    ...
    "subject": [{"name": "ghcr.io/tomlawesome/birdcage", "digest": {"sha256": digest.split(":", 1)[1]}}],
    "predicate": {
...
print(json.dumps({
    "_type": "https://in-toto.io/Statement/v0.1",
    "predicateType": "https://tomlawson.io/attestations/birdcage-validation/v1",
    "subject": [{"name": "ghcr.io/tomlawesome/birdcage", "digest": {"sha256": subject_digest.split(":", 1)[1]}}],
    "predicate": {
        "commit": commit, "ref": ref, "pipelineId": int(pipeline_id),
        "pipelineUrl": "https://gitlab.tomlawson.io/ai/birdcage/-/pipelines/%s" % pipeline_id,
...
: > "$work/unused.pub"
got=0
out="$(BIRDCAGE_IMAGE=ghcr.io/tomlawesome/birdcage BIRDCAGE_DIGEST="$digest" \
